...
**Note**: When using Sine mod manager, the mod is automatically installed in the `chrome/sine-mods/` folder. With `"js": true` in `theme.json`, Sine automatically discovers and loads the `.uc.js` file.
